...
export function GlassButton({ ref, children, icon: Icon, size = 'default', active = false, variant = 'default', interactive = true, className, onClick, ...props }: GlassButtonProps & { ref?: React.RefObject<HTMLButtonElement | null> }) {
