            ...
            >
              <div className={`${isLeft ? 'md:text-right' : 'md:invisible'}`}>
                ...
                {isLeft
                  ? (
                      <div>
                        <h3 className="my-2 font-portfolio-serif text-[32px] leading-none text-neutral-950">
                          {item.dateLabel}
                        </h3>
                        <div
                          className={`inline-block w-75% rounded-[2px] px-4 py-4 shadow-[0_0_14px_${cardTone}] bg-[${cardTone}]`}
                        >
                          <p className="my-2 font-portfolio-mono whitespace-pre-line mt-2 text-[16px] font-semibold leading-5 text-neutral-900">
                            {item.title[locale]}
                          </p>
                        ...
                        <h4 className="font-portfolio-serif text-[28px] leading-none text-neutral-400">
                          {item.start}
                        </h4>
                      </div>
                    )
                ...
                {!isLeft
                  ? (
                      <div>
                        ...
                        >
                          <p className="my-2 font-portfolio-mono mt-2 text-[16px] font-semibold leading-5 text-neutral-900">
                            {item.title[locale]}
                          </p>
                          <p className="font-portfolio-sans text-[12px] text-neutral-700">
                            {item.organization[locale]}
