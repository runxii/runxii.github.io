...
export default function ProjectCard({ project, locale }: ProjectCardProps) {
  return (
    <article
      className="flex h-[480px] flex-col rounded-[20px] bg-white/78 mx-4 px-5 pb-5 pt-4 shadow-[0_10px_30px_rgba(0,0,0,0.07)] ring-1 ring-neutral-200/80 backdrop-blur"
    >
      ...
      <div className="mt-auto flex items-center justify-end gap-4 pt-5 text-[14px]">
        {project.link
          ? (
              <Link
